...
var PeerProblems = []PeerProblem{
	{
		...
		Choices: []PeerChoice{
			{ID: 1, Value: "ไม่มีความถูกต้อง เนื่องจากยังมี Entity ไม่ครบตามความต้องการของระบบ"},
			{ID: 2, Value: "ไม่มีความถูกต้อง เนื่องจาก Entity ยังสามารถเพิ่มเติมให้ใช้งานง่ายขึ้นได้"},
